...
silent only
cd ~/Dropbox/2013.1/Projeto_Final/Execucao/Alg/src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 distcalc.cpp
badd +1 ../app/csidraw.cpp
badd +1 ../app/visualize.cpp
badd +17 config.mak
badd +0 ../app/config.mak
badd +0 ../include/distcalc.h
badd +0 Lado1.df
args distcalc.cpp
edit distcalc.cpp
...
silent! normal! zE
let s:l = 73 - ((0 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
normal! 05|
tabedit ../app/config.mak
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 149 - ((0 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
149
normal! 05|
tabedit ../app/csidraw.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 97 - ((5 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
